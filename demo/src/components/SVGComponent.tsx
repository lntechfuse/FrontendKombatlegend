...
const SVGComponent: React.FC<SVGProps> = ({ width, height, ...props }) => {
  const [hexColor, setHexColor] = useState("black");

  const handleHexClick = () => {
    setHexColor(hexColor === "black" ? "pink" : "black");
  };
  return (
    <svg
    width={660}
  ...
  >
    ...
    />
    <path
      d="M161 85.9312L186 46.054L235.999 46.2997L260.999 86.4226L235.999 126.3L186 126.054L161 85.9312Z"
      fill="#1E1E1E"
      stroke="#6A6A6A"
      strokeWidth={5}
    />
    <path
      d="M240 43.9312L265 4.054L314.999 4.2997L339.999 44.4226L314.999 84.2997L265 84.054L240 43.9312Z"
      fill="#1E1E1E"
      stroke="#6A6A6A"
      strokeWidth={5}
    />
    <path
      d="M319 85.9312L344 46.054L393.999 46.2997L418.999 86.4226L393.999 126.3L344 126.054L319 85.9312Z"
      fill="#1E1E1E"
      stroke="#6A6A6A"
      strokeWidth={5}
    />
    <path
      d="M398 43.9312L423 4.054L472.999 4.2997L497.999 44.4226L472.999 84.2997L423 84.054L398 43.9312Z"
      fill="#1E1E1E"
      stroke="#6A6A6A"
      strokeWidth={5}
    />
    <path
      d="M477 85.9312L502 46.054L551.999 46.2997L576.999 86.4226L551.999 126.3L502 126.054L477 85.9312Z"
      fill="#1E1E1E"
      stroke="#6A6A6A"
      strokeWidth={5}
    />
    <path
      d="M556 44.9312L581 5.054L630.999 5.2997L655.999 45.4226L630.999 85.2997L581 85.054L556 44.9312Z"
      fill="#1E1E1E"
      stroke="#6A6A6A"
      strokeWidth={5}
    />
    <path
      d="M82.4043 43L107.404 3.12285L157.403 3.36855L182.403 43.4914L157.403 83.3685L107.404 83.1228L82.4043 43Z"
      fill="#1E1E1E"
      stroke="#6A6A6A"
      strokeWidth={5}
    />
