...
import Hexagon from "./Hexagon"; // ตรวจสอบให้แน่ใจว่า Hexagon component รองรับ prop currentPlayer

interface SVGComponentProps extends React.SVGProps<SVGSVGElement> {
  currentPlayer: number;
}

const SVGComponent: React.FC<SVGComponentProps> = ({ currentPlayer, ...props }) => {
  return (
    <svg
      width={660}
      height={702}
